# Aseprite - Custom Build

> **Note:** This is a custom-compiled build of Aseprite from the official open-source repository.  
> For official releases with automatic updates and Steam features, visit [aseprite.org](https://www.aseprite.org/)

## 📦 Download

**Latest Release:** [v1.3.16.1-custom](../../releases/latest)

- **Platform:** Windows x64
- **Build Type:** RelWithDebInfo (Optimized with Debug Info)
- **Graphics Backend:** Skia m124
- **Compiler:** MSVC 19.50 (Visual Studio 2022)

### Installation
1. Download `Aseprite.zip` from the [Releases](../../releases) page
2. Extract to your desired location
3. Run `aseprite.exe`

**Important:** Keep all files together - the executable requires DLLs and the data folder to function properly.
...
**About This Build:**
This is an unofficial custom build compiled from the official Aseprite source code for personal use.

**Original Aseprite License:**
